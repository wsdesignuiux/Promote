...
import com.example.vaibhav.promote.R;

import java.util.ArrayList;
import model.PromoteModel;
...
public class PromoteAdapter extends RecyclerView.Adapter<PromoteAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_electronics,parent,false);
